            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4">
                <textarea
                  ...
                  readOnly={!canEdit}
                  className={`w-full text-sm text-gray-700 placeholder-gray-300 focus:outline-none bg-transparent leading-relaxed resize-none overflow-hidden ${!canEdit ? 'cursor-default select-text' : ''}`}
                  style={{ minHeight: '100%' }}
                />
              </div>
